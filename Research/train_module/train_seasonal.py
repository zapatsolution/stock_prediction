...
INPUT_PATH = '/home/manoj/Downloads/office/trading_bot/data'
OUTPUT_PATH = '/home/manoj/Downloads/office/trading_bot/data/' + "/outputs/param_1_Hours"
...
df_ge = pd.read_csv(os.path.join(INPUT_PATH, "bitcoin_data_v1.csv"))
df_ge = add_seasonal_data(df_ge)
df_ge.to_csv('bitcoin_seasonal_Data.csv',index=False)
exit()
print(df_ge.shape)
print(df_ge.columns)
print(df_ge.head(5))
...
print(df_ge.dtypes)
train_cols = ["open", "high", "low", "close", "Volume","open_seasonal","close_seasonal","low_seasonal","high_seasonal"]
...
train_T = min_max_scaler_t.fit_transform(df_train.loc[:, test_cols])
